############################################################
# 7COM1079 – Final Report
# Analysis.R (SHOW PLOTS ONLY – NOTHING SAVED)
#
# Dataset:
#   C:/Users/MrLaptop/Desktop/webs/diet/Fat_Supply_Quantity_Data.csv
#
# Research Type:
#   Correlation between Animal Fat Supply and Plant (Vegetal) Fat Supply
############################################################
